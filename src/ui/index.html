...
<head>
    ...
    <title>คำนวณค่าธรรมเนียมศาลและค่าป่วยการ</title>
...
<div id="wrapper">
        ...
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.php">
						<!-- <h5 class="h-bold">สำนักงานศาลยุติธรรม</h5> -->
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
				...
				<!-- <li><a href="#boxes">แนะนำการใช้งาน</a></li> -->
				<li><a href="#calculate">คำนวณ</a></li>
				<li><a href="#footer">ติดต่อเรา</a></li>
			
				<!-- <li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge custom-badge red pull-right">Extra</span>More <b class="caret"></b></a>
				  <ul class="dropdown-menu">
					<li><a href="index.php">Home form</a></li>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h4 class="h-ultra">คำนวณค่าธรรมเนียมศาลและค่าป่วยการ</h4>
					</div>
					...
					<!-- <h4 class="h-light">Provide <span class="color">best quality healthcare</span> for you</h4> -->
						...
						<ul class="lead-list">
								...
								</span> <strong>คำนวณค่าใช้จ่ายด้วยตัวท่านเอง</strong><br />
								<span class="fa-stack fa-lg">
									<i class="fa fa-circle fa-stack-2x"></i>
									<i class="fa fa-clock-o fa-stack-2x fa-inverse"></i>
								</span> <strong>ใช้บริการได้สะดวกทุกที่ทุกเวลา</strong><br />
								<span class="fa-stack fa-lg">
									<i class="fa fa-circle fa-stack-2x"></i>
									<i class="fa fa-mobile fa-stack-2x fa-inverse"></i>
								</span> <strong>ขั้นตอนง่ายๆผ่านมือถือของคุณ</strong>
							<!-- <li><span class="fa fa-calculator fa-2x "></span> <span class="list"><strong>คำนวณค่าใช้จ่ายด้วยตัวท่านเอง</strong><br /></span></li>
							<li><span class="fa fa-clock-o fa-2x "></span> <span class="list"><strong>ใช้บริการได้สะดวกทุกที่ทุกเวลา</strong><br /></span></li>
							<li><span class="fa fa-mobile fa-2x "></span> <span class="list"><strong>ขั้นตอนง่ายๆผ่านมือถือของคุณ</strong><br /></span></li> -->
						</ul>
	...
	<!-- Section: team -->
    <section id="calculate" class="home-section bg-gray paddingbot-60">
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="section-heading text-center">
					<h2 class="h-bold">คำนวณค่าธรรมเนียมศาลและค่าป่วยการ</h2>
				...
				<div class="col-lg-8 col-lg-offset-2">
					<div class="form-wrapper">
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="panel panel-skin">
								<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> โปรดใส่ข้อมูลให้ครบถ้วน <small></small></h3>
								</div>
								<div class="panel-body">
									<form role="form" class="lead">
									<div id="plaintiff">	
            ...
            <div id="grid-container" class="cbp-l-grid-team">
                <ul>
                    <li class="cbp-item psychiatrist">
                        <a href="calculates/member1.html" class="cbp-caption cbp-singlePage">
                        ...
                        <a href="calculates/member1.html" class="cbp-singlePage cbp-l-grid-team-name">Alice Grue</a>
                        <div class="cbp-l-grid-team-position">Psychiatrist</div>
                    </li>
                    <li class="cbp-item cardiologist">
                        <a href="calculates/member2.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                        ...
                        <a href="calculates/member2.html" class="cbp-singlePage cbp-l-grid-team-name">Joseph Murphy</a>
                        <div class="cbp-l-grid-team-position">Cardiologist</div>
                    </li>
                    <li class="cbp-item cardiologist">
                        <a href="calculates/member3.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                        ...
                        <a href="calculates/member3.html" class="cbp-singlePage cbp-l-grid-team-name">Alison Davis</a>
                        <div class="cbp-l-grid-team-position">Cardiologist</div>
                    </li>
                    <li class="cbp-item neurologist">
                        <a href="calculates/member4.html" class="cbp-caption cbp-singlePage">
                            <div class="cbp-caption-defaultWrap">
                        ...
                        <a href="calculates/member4.html" class="cbp-singlePage cbp-l-grid-team-name">Adam Taylor</a>
			...
			<div class="row">
				<div class="col-sm-12 col-md-8">
					...
					<div class="widget">
						...
						<p>
					    อาคารศาลอาญา ชั้น 4 ถนนรัชดาภิเษก แขวงจอมพล เขตจตุจักร กรุงเทพมหานคร 10900
						</p>
					</div>
					</div>
					<!-- <div class="wow fadeInDown" data-wow-delay="0.1s">
				...
				<div class="col-sm-6 col-md-4">
					...
					<!-- <div class="widget">
						<h5>สำนักเทคโนโลยีสารสนเทศ</h5>
						<p>อาคารศาลอาญา ชั้น 4 ถนนรัชดาภิเษก แขวงจอมพล เขตจตุจักร กรุงเทพมหานคร 10900</p>		
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-left">
					<p>&copy;Copyright 2018 - COJ. All rights reserved.</p>
					</div>
					</div>
				</div>
				<!-- <div class="col-sm-6 col-md-6 col-lg-6">
